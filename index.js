...
// Create empty arrays that store the team members and id as place holders corresponding to each individual.
const teamArr = [];
const idArr = [];
...
function initApp() {
    ...
    // Prompt user to create a manager profile
    function addManager() {
    ...
    // function to add Engineer's profile
    ...
    // function to prompt the user and  create  an Intern profile
    function addIntern() {
        inquirer.prompt([
            {
                type: "input",
